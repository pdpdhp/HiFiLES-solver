...
bool eles_tris::set_2D_StiffMat_ele(array<double> &stiffMat_ele, int ele_id) {
	...
	global_id = ele2global_ele(ele_id);
	n_spts = n_spts_per_ele(ele_id);
	...
	for (int i=0; i<n_spts; i++)
		pos_spts[i] = get_pos_spt(ele_id,i);
