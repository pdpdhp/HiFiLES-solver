    ...
    for(k=0;k<p_res-1;++k){
      for(l=0;l<p_res-1;++l){
        for(m=0;m<p_res-1;++m){
          ...
          connectivity_plot(4,count) = ppt_to_pnode(j,vertex_4);
          connectivity_plot(5,count) = ppt_to_pnode(j,vertex_5);
          connectivity_plot(6,count) = ppt_to_pnode(j,vertex_6);
          connectivity_plot(7,count) = ppt_to_pnode(j,vertex_7);
          count++;
        }
      }
    }	
	...
	for(k=0;k<p_res-1;++k)
		{
          ...
          connectivity_plot(4,count) = vertex_4+1;
          connectivity_plot(5,count) = vertex_5+1;
          connectivity_plot(6,count) = vertex_6+1;
          connectivity_plot(7,count) = vertex_7+1;
          count++;
